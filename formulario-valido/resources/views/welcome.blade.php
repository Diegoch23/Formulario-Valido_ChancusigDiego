        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                       <a href="{{ route('login.personalizado') }}" class="text-sm text-gray-700 underline">Login Personalizado</a>

                        @if (Route::has('register'))
                            <a href="{{ route('registro.personalizado') }}" class="ml-4 text-sm text-gray-700 underline">Registro Personalizado</a>
                        @endif
                    @endauth
                </div>
            @endif
